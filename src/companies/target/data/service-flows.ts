 ...
 *
 *   at-risk / late  → re-promise the date (and say what it does to the set crew)
      ...
      text: slipped
        ? `Promised ${o.promisedOn}, the record now believes ${o.currentEta}.` +
          (o.crewBooked && o.installOn
            ? ` A set crew is booked for ${o.installOn} and cannot be moved — that is what the slip actually breaks.`
            : " No set crew is booked against it, so the slip costs a conversation, not a re-book.")
    ...
    : {
        ...
        body: slipped
          ? [
              ...
              o.crewBooked && o.installOn
                ? `We know a set crew is booked for ${o.installOn}. Tell us whether to hold the date and split the shipment, or move the floor-set — we will carry the re-book either way.`
  ...
  return {
    ...
    outcome: {
      ...
      artifact: struggling
        ? {
            ...
            body: [
              ...
              `We are putting your orders on the earlier carrier cut-off and holding safety stock on your two fastest items. You should feel the difference inside a quarter.`,
      ...
      prompts: [
        ...
        struggling ? "Escalate to the supplier?" : "Are they a growth candidate?",
      ],
    },
  };
}
