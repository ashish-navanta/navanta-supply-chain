 ...
 * the transport seat.
 *
 * The seat sits at the Woodland RDC — the first inland node behind the LA/Long
 * Beach gateway — so the inbound side of this book is the port dray (Luen Hing
 * hardgoods off the Yantian sailings, Vinh Phat textiles out of Cai Mep) and the
 * outbound side is the store and account deliveries the dedicated units pull.
 * Port dwell, chassis shortages and peak gate cuts are the exceptions that land
 * here first.
 */
...
export const LOADS: Load[] = [
  /* ── The workshop order's legs ──────────────────────────────── */
  {
    id: "LD-70412",
    orderId: "SO-4471",
    account: "Peachtree Jewelers",
    lane: "Woodland RDC → Atlanta, GA",
    origin: "Woodland RDC",
    destination: "Atlanta, GA",
    miles: 92,
    haul: "fleet",
    carrier: "Target Fleet · Air",
    unitId: "218",
    trailerId: "TR-4471",
    stage: "rolling",
    health: "eta-conflict",
    ...
    etas: [
      {
        ...
        eta: "Today 14:20",
        confidence: 92,
        note: "Tractor telematics — 41 miles out, moving, and the only source reading the truck itself.",
      },
      {
        ...
        eta: "Today 15:40",
        confidence: 74,
        note: "Trailer tracker last pinged 38 minutes ago at the Emerson exit — it lags the tractor by design.",
      },
      {
        ...
        eta: "Today 17:00",
        confidence: 41,
        note: "Shipment-level estimate built from the tender, not from the truck. Stale by two stops.",
      },
    ],
    note: "Three systems, three answers, one truck · the tractor feed is 41 miles out and the 14:20 appointment holds",
  },
  {
    id: "LD-70398",
    orderId: "SO-4529",
    account: "Gulf Coast Jewelers",
    lane: "Woodland RDC → Biloxi, MS",
    origin: "Woodland RDC",
    ...
    etas: [
      ...
      },
      {
        ...
        eta: "Today 15:30",
        confidence: 68,
        note: "Receiving has one door open and two trucks ahead. The appointment is not the reality.",
      },
    ],
    note: "At the gate 20 minutes early · two ahead in the queue, so the 2pm window needs confirming with the site",
  },
  {
    id: "LD-70402",
    orderId: "SO-4529",
    ...
    etas: [
      ...
      },
      {
        ...
        eta: "8 Aug",
        confidence: 100,
        note: "Receipt GR-4471-02 posted complete.",
      },
    ],
    pod: {
      signedBy: "Tony Bergeron",
      at: "8 Aug · 11:20",
      exception: "2 units crushed under the wrap — throw cases photographed at the tailgate before the driver left",
      shortPallets: 2,
    },
  ...
  /* ── Carrier and capacity decisions ─────────────────────────── */
  {
    ...
    lane: "Long Beach → Woodland RDC",
    origin: "Long Beach Port",
    destination: "Woodland RDC",
    miles: 402,
    haul: "purchased",
    ...
    etas: [
      {
        ...
        eta: "Tomorrow 09:00",
        confidence: 60,
        note: "Tender is out to Kuehne+Nagel and unaccepted — the terminal is short of chassis and the date is the ask, not a commitment.",
      },
    ],
    note: "Luen Hing stoneware off the Yantian sailing, discharged at Long Beach and on day three of port dwell · Kuehne+Nagel quoted $2,400 over the fleet's all-in on the dray · #331 clears Woodland RDC at 06:40 and could take it",
  },
  {
    id: "LD-70460",
    account: "Summit Department Stores",
    lane: "Woodland RDC → Salt Lake City, UT",
    origin: "Woodland RDC",
    destination: "Salt Lake City, UT",
    miles: 1_842,
    haul: "fleet",
    carrier: "Target Fleet · Ocean",
    unitId: "331",
    trailerId: "TR-4502",
    stage: "dispatched",
    health: "recovering",
    ...
    etas: [
      {
        ...
        eta: "Today 16:20",
        confidence: 88,
        note: "Recovery unit rolling from Woodland RDC. Hours are legal to the relay point.",
      },
    ],
    note: "Original unit went out on a coolant fault at Chattanooga · recovery costed at $2,400 and ready to dispatch",
  },
  {
    id: "LD-70471",
    account: "Piedmont Jewelers",
    lane: "Woodland RDC → Birmingham, AL",
    origin: "Woodland RDC",
    destination: "Birmingham, AL",
    miles: 148,
    haul: "purchased",
    carrier: "Forwarder · DSV",
    stage: "tendered",
    health: "unassigned",
    ownPallets: 60,
    ownValue: 41_800,
    ...
    note: "Empty return on this lane costs $3,800 a month · a Birmingham backhaul is open and expires at 09:00",
  },
  ...
  /* ── Running clean ──────────────────────────────────────────── */
  {
    ...
    lane: "Woodland RDC → Asheville, NC",
    origin: "Woodland RDC",
    ...
    etas: [
      {
        ...
        eta: "23 Aug 10:30",
        confidence: 81,
        note: "Carrier feed is current — scanned at Salt Lake this morning.",
      },
      {
        system: "Carrier site",
        scope: "shipment",
        eta: "23 Aug 12:00",
        confidence: 52,
        note: "Old Dominion's portal is a day stale, as usual on this lane.",
      },
    ],
    note: "Purchased lane, carrier feed current · no fleet capacity north of Redding this week anyway",
  },
  {
    id: "LD-70463",
    orderId: "SO-4488",
    account: "Blue Ridge Jewelers",
    lane: "Cedar Falls RDC → Asheville, NC",
    origin: "Cedar Falls RDC",
    destination: "Asheville, NC",
    miles: 296,
    haul: "purchased",
    carrier: "Forwarder · Kuehne+Nagel",
    ...
    etas: [
      {
        ...
        eta: "22 Aug 12:40",
        confidence: 79,
        note: "Picked up on time.",
      },
    ],
    note: "Running to plan · Kuehne+Nagel is 6% under the fleet's all-in on this lane",
  },
  {
    id: "LD-70448",
    orderId: "SO-4444",
    ...
    note: "Long haul on purchased capacity · the fleet has no legal hours for a 1,842-mile run this week",
  },
  ...
  /* ── Delivered ──────────────────────────────────────────────── */
  {
    ...
    orderId: "SO-4377",
    account: "Piedmont Jewelers",
    lane: "Woodland RDC → Greensboro, NC",
    origin: "Woodland RDC",
  ...
  },
  {
    ...
    note: "Delivered clean · detention ran 3 hours at the dock and is still open at audit",
  },
  {
    id: "LD-70427",
    orderId: "SO-4402",
    ...
    note: "Signed clean · backhaul filled out of Greensboro, so the return ran loaded",
  },
];
...
/* The "fleet": dedicated contract carriage at the Woodland RDC — carrier-owned
   iron under a monthly commitment, the only wheels this book pays for by the
   month. The retailer owns no tractors here; the seat has no single TMS of
   record either (a legacy WMS on one side, order management on the other),
   which is why every ETA on this seat is a list of claims from named systems
   rather than a field. */
export const FLEET: PowerUnit[] = [
  ...
  },
  {
    ...
    loadedMiles: 7_120,
    emptyMiles: 890,
    note: "Cleared Woodland RDC at 06:40 with a full clock · the only unit legal for either the recovery or the Long Beach dray",
  },
  {
    id: "276",
  ...
  },
  {
    ...
    loadedMiles: 5_890,
    emptyMiles: 720,
    note: "Full clock and the best loaded ratio in the fleet · under-used because the Woodland desk dispatches by habit",
  },
];
...
export const LANES: Lane[] = [
  /* The outbound legs out of Woodland, the inbound dray off the LA/Long Beach
     gateway, and the one domestic grocery lane into Cedar Falls. The retailer
     owns no fleet in this book — "fleet" on these rows is DEDICATED CONTRACT
     CARRIAGE, a handful of units under a monthly commitment at the Woodland
     RDC. The fleet-vs-purchased economics are real; the iron is the carrier's. */
  {
    id: "WDL-ATL",
    origin: "Woodland RDC",
    destination: "Atlanta, GA",
    ...
    fleetShare: 88,
    backhaulCoverage: 71,
    note: "Dense outbound corridor — the dedicated units win clearly and already run it",
  },
  {
    id: "WDL-BHM",
    origin: "Woodland RDC",
  ...
  },
  {
    ...
    fleetShare: 18,
    backhaulCoverage: 63,
    note: "The import book's inland leg — Luen Hing hardgoods off the Yantian sailings and Vinh Phat textiles out of Cai Mep both discharge at LA/Long Beach and land here. BNSF intermodal bought out of habit; the dedicated dray is $0.38 under on the weeks a unit is clear, and it skips the chassis queue",
  },
  {
    id: "RVF-CDF",
    origin: "River Falls, WI",
    destination: "Cedar Falls RDC",
    miles: 239,
    loadsThisMonth: 16,
    ...
    fleetShare: 61,
    backhaulCoverage: 44,
    note: "The domestic grocery lane — Good & Gather out of the Cedar Mills co-pack by truck, no port and no tariff. Close to even · the return coverage is what decides it either way",
  },
  {
    id: "WDL-GSO",
    origin: "Woodland RDC",
  ...
  },
  {
    ...
    fleetShare: 9,
    backhaulCoverage: 36,
    note: "The air book's last mile — recovery and set-launch freight escalated out of HKG when a Yantian consolidation misses its vessel. Bought, correctly, and worth leaving alone",
  },
  {
    id: "WDL-SLC",
    origin: "Woodland RDC",
...
export const BACKHAULS: BackhaulOffer[] = [
  ...
  },
  {
    ...
    deliver: "Woodland, CA · Today 19:00",
    revenue: 640,
    milesOutOfRoute: 4,
    expiresInHours: 4,
    unitId: "218",
  },
  {
    ...
    deliver: "Woodland, CA · Tomorrow 15:00",
    revenue: 1_420,
    milesOutOfRoute: 8,
    expiresInHours: 19,
  },
  {
    ...
    deliver: "Woodland RDC · Tomorrow 14:30",
    revenue: 890,
    milesOutOfRoute: 21,
    expiresInHours: 21,
    unitId: "276",
...
export const ACCESSORIALS: Accessorial[] = [
  ...
  },
  {
    ...
    status: "accruing",
    amount: 350,
    note: "Recovery unit lays over at Woodland RDC tonight · costed into the $2,400 recovery, not a surprise",
  },
  {
    id: "AC-8790",
    loadId: "LD-70441",
