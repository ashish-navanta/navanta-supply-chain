/* ═══════════════════════════════════════════════════════════════
 *  Allison Transmission — exception queues
 *
 *  The order the workshop follows: 2,880 drums of spindle coolant
 *  against a committed shutdown date, hit by a SUPPLIER LEAD-TIME
 *  INCREASE — the Indianapolis repair line's lead time jumps 10 days
 *  for the next three months — and arriving with TWO DRUMS STOVE IN
 *  at the plant dock.
 *
...
/* The vocabulary a planner or a logistics coordinator already uses, rather
   ...
   the second is an in-transit exception, and both are terms an Allison reader can
...
export interface InsightCtx {
  ...
  count?: number;
  /** Counterparty is Allison-operated. */
  own?: boolean;
  ...
  switch (signal) {
    ...
    case "alternate-accepted":
      /* Two moves, one answer: the substitute that saves the floor-set and the date
         ...
         is a category and AL5605-5799 is a decision. */
...
/**
 * Claim facts for a service row. A damage claim is settled from records Allison
...
export interface ActionRow {
  ...
  party: string;
  /** True when the counterparty is Allison-operated. */
  partyOwn: boolean;
   ...
   * differently ("Deep Groove Ball Bearing 6205-2RS" against "Soft surface ·
 ...
 *
 * So the base is looked up, and the manufacturer variants count up from
 ...
 *
 * The book these rows describe is Allison's own — the MRO book out of Machine & Equipment Repairs,
 * Industrial Supplies and Cutting Tools — so the parts map onto real material
 * numbers and the SKUs become real ordering references: AL5605-5605 is the
 ...
 * index gave "00318-2205", which meant "the second variant of Modal" and could
...
const CATALOGUE_STYLE: Record<string, string> = {
  "Deep Groove Ball Bearing 6205-2RS": "AL5605",
  "Spindle Coolant Concentrate 55gal": "AL7108",
  "Carbide End Mill 1/2in 4-Flute": "AL2980",
  "Hydraulic Filter Element 10µ": "AL3192",
  "Nitrile Gloves 8mil 100ct": "AL4735",
  "V-Belt B-Section 68in": "AL3184",
  "Absorbent Pads 15×19 100ct": "AL3843",
  "Allen-Bradley Contactor 100-C23": "AL9204",
};

/**
 * The SKU for a style, and the SKUs of its manufacturer variants.
 *
...
export function skuForStyle(style: string, variant = 0): string {
  ...
  if (product) {
    /* Wrapping rather than clamping: a purchase order that splits into more
       lines than the style has variants should come back round the book, not
...
export function linesFor(row: ActionRow): RowLine[] {
  ...
  return weights.map((w, i) => {
    ...
    qtyLeft -= qty;
    valueLeft -= value;
    /* The line's name comes off the SKU, not from a parallel list of variant
       words. Those two had already drifted: the number said AL5605-5605, which
       is Road Trip, while the label beside it said Walnut Ember — a made-up
       variant from a made-up axis, printed against a real reference. One
...
const BUYER: ActionRow[] = [
  ...
  R({
    ...
    party: "Cline Tool & Service Co", partyOwn: false,
    product: "Spindle Coolant Concentrate 55gal",
  ...
  R({
    ...
    party: "Kirby Risk Supply Co", partyOwn: false,
    product: "Nitrile Gloves 8mil 100ct",
  ...
  R({
    ...
    party: "Cline Tool & Service Co", partyOwn: false,
    product: "Deep Groove Ball Bearing 6205-2RS",
  ...
  R({
    ...
    party: "Kirby Risk Supply Co", partyOwn: false,
    product: "Hydraulic Filter Element 10µ",
  ...
  R({
    ...
    party: "Fastenal Onsite (Integrated Supply)", partyOwn: true,
    product: "Allen-Bradley Contactor 100-C23",
 ...
 * AL5605-5605 showed 24 units while PO-4463 — the same style, the order this
...
const PLANNER: ActionRow[] = [
  ...
  R({
    ...
    id: "p1", state: "decide", ref: "Deep Groove Ball Bearing 6205-2RS", refSub: "SKU AL5605-5605",
    party: "Indy Central Stores", partyOwn: true,
    product: "Deep Groove Ball Bearing 6205-2RS",
    ...
    cover: coverFor({
      ...
      moq: 96, classification: "AZ", supplier: "Cline Tool & Service Co",
      incoming: incomingFor("AL5605-5605"),
    }),
  }, { upstream: "PO-4463" }),

  R({
    id: "p2", state: "decide", ref: "Spindle Coolant Concentrate 55gal", refSub: "SKU AL7108-7110",
    party: "Indy Central Stores", partyOwn: true,
    product: "Spindle Coolant Concentrate 55gal",
    ...
    cover: coverFor({
      ...
      moq: 144, classification: "AY", supplier: "Cline Tool & Service Co",
      incoming: incomingFor("AL7108-7110"),
    }),
  }),

  R({
    id: "p3", state: "decide", ref: "Nitrile Gloves 8mil 100ct", refSub: "SKU AL4735-4735",
    party: "Szentgotthárd Stores", partyOwn: true,
    product: "Nitrile Gloves 8mil 100ct",
    ...
    cover: coverFor({
      ...
      moq: 144, classification: "AZ", supplier: "Kirby Risk Supply Co",
      incoming: incomingFor("AL4735-4735"),
    }),
  }),

  R({
    id: "p4", state: "decide", ref: "V-Belt B-Section 68in", refSub: "SKU AL3184-3184",
    party: "Indy Central Stores", partyOwn: true,
    product: "V-Belt B-Section 68in",
    ...
    cover: coverFor({
      ...
      moq: 96, classification: "BY", supplier: "Kirby Risk Supply Co",
      incoming: incomingFor("AL3184-3184"),
    }),
  }),

  R({
    id: "p5", state: "decide", ref: "Allen-Bradley Contactor 100-C23", refSub: "SKU AL9204-9204",
    party: "Szentgotthárd Stores", partyOwn: true,
    product: "Allen-Bradley Contactor 100-C23",
    ...
    cover: coverFor({
      ...
      moq: 72, classification: "BZ", supplier: "Cline Tool & Service Co",
      incoming: incomingFor("AL9204-9204"),
    }),
  }),

  R({
    id: "p6", state: "decide", ref: "Absorbent Pads 15×19 100ct", refSub: "SKU AL3843-3843",
    party: "Indy Central Stores", partyOwn: true,
    product: "Absorbent Pads 15×19 100ct",
    ...
    cover: coverFor({
      ...
      moq: 96, classification: "CY", supplier: "Cline Tool & Service Co",
      incoming: incomingFor("AL3843-3843"),
    }),
  }),

  R({
    id: "p7", state: "settled", ref: "Deep Groove Ball Bearing 6205-2RS", refSub: "SKU AL5605-5799",
    party: "Indy Central Stores", partyOwn: true,
    product: "Deep Groove Ball Bearing 6205-2RS",
    ...
    cover: coverFor({
      ...
      moq: 96, classification: "CZ", supplier: "Kirby Risk Supply Co",
      incoming: incomingFor("AL5605-5799"),
    }),
  }, { units: 624 }),
];
...
const CSR: ActionRow[] = [
  R({
    ...
    party: "Plant 12 Maintenance", partyOwn: false,
    product: "Spindle Coolant Concentrate 55gal",
  ...
  R({
    ...
    party: "Speedway Maintenance", partyOwn: false,
    product: "Spindle Coolant Concentrate 55gal",
  ...
  R({
    ...
    party: "Plant 14 Maintenance", partyOwn: false,
    product: "Nitrile Gloves 8mil 100ct",
  ...
  R({
    /* Both halves of a good outcome, on one line: the account has taken the
       ...
       18 of the 64 units stop waiting on Fastenal Onsite altogether. What is left for
  ...
  R({
    /* The alternate came off a different purchase order — that is what taking an
       ...
       order this date now depends on, and the answer is Cline Tool & Service Co's. */
    id: "c6", state: "settled", ref: "SO-4390", refSub: "Alternate accepted",
    chainFrom: "PO-4402",
    party: "Plant 12 Maintenance", partyOwn: false,
    product: "Carbide End Mill 1/2in 4-Flute",
  ...
  R({
    ...
    party: "Plant 3 Tool Room", partyOwn: false,
    product: "Deep Groove Ball Bearing 6205-2RS",
...
const LOGISTICS: ActionRow[] = [
  R({
    /* SO-4390, not SO-4471 — the order record already said so and was being
       contradicted here. Its PRO number is SS-70412, its carrier is the stores shuttle
       #218 and its lane is Indy Central Stores → Atlanta: this load, named three
       ...
       times. */
    id: "l1", state: "decide", ref: "LD-70412", refSub: "Indy Central Stores → Atlanta, GA",
    chainFrom: "SO-4390",
  ...
  R({
    /* The one inbound move on the book: Kirby Risk Supply Co's Color Choice is on the quay at
    ...
    id: "l2", state: "decide", ref: "LD-70455", refSub: "Long Beach → Indy Central Stores",
    chainFrom: "PO-4488",
  ...
  R({
    /* The outbound leg of SO-4463 — the order this whole demo follows, from
       Cline Tool & Service Co's capped line through Iris's stocking policy to Christy's
       re-promise. Every figure on the row is the order's own: 64 units of
       Modal, $88,400, dedicated carriage down Indy Central Stores → Szentgotthárd Stores, arriving
    ...
    id: "l3", state: "decide", ref: "LD-70398", refSub: "Indy Central Stores → Salt Lake City, UT",
  ...
  R({
    /* Its own order, not SO-4463. Two loads against one sales order — a
       ...
       carrier, which is exactly the order an Allison Global Supply air recovery is costed
       against. */
    id: "l5", state: "decide", ref: "LD-70460", refSub: "Recovery costed",
    chainFrom: "SO-4436",
    party: "Allison Global Supply · Air", partyOwn: true,
    product: "Absorbent Pads 15×19 100ct",
  ...
  R({
    id: "l7", state: "settled", ref: "LD-70470", refSub: "Indy Central Stores → Charlotte, NC",
    chainFrom: "SO-4377",
  ...
  R({
    id: "l8", state: "settled", ref: "LD-70350", refSub: "Chennai Stores → Indy Central Stores",
    chainFrom: "SO-4547",
    party: "Allison Global Supply · Ocean", partyOwn: true,
    product: "Absorbent Pads 15×19 100ct",
...
const CONTACTS: Record<string, PartyContact> = {
  /* One contact per vendor — and WHOSE person they are follows ownership.
     Cline Tool and Kirby Risk are independent distributors, so the card is
     their inside-sales rep: the person who actually answers when a buyer
     chases a line. Fastenal Onsite is the dedicated crib on Allison's own
     site, so the card is the onsite site manager on an allisontransmission.com
     address — they sit in the building. Getting this the other way round would
     have put Allison employees inside vendors Allison does not own. */
  "Cline Tool & Service Co": {
    name: "Kenny Doyle", role: "Inside sales · repair desk",
    phone: "+1 (317) 555-0129", email: "k.doyle@clinetool.com",
    hours: "Indianapolis, IN · 7am–4pm ET",
    respondsIn: "Answers the phone same shift", prefers: "call",
  },
  "Kirby Risk Supply Co": {
    name: "Priscilla Nguyen", role: "Account manager · electrical",
    phone: "+1 (765) 555-0177", email: "p.nguyen@kirbyrisk.com",
    hours: "Lafayette, IN · 7am–5pm ET",
    respondsIn: "Answers same shift", prefers: "call",
  },
  "Fastenal Onsite (Integrated Supply)": {
    name: "Arjun Mehta", role: "Onsite site manager",
    phone: "+1 (317) 555-0042", email: "arjun.mehta@allisontransmission.com",
    hours: "Indy Central Stores · on site 6am–3pm ET",
    respondsIn: "Walk up to the crib, or email overnight", prefers: "email",
  },
  /* The plant maintenance teams — the receiving side of every re-promise and
     claim. Every one of them is an Allison employee on an allisontransmission.com
     address, which is the whole difference from the block above: chasing a
     vendor is a commercial conversation, and chasing a crib is an internal one.
     The habits are the ones `service.ts` records against each team, so the card
     and the account note cannot contradict each other. */
  "Plant 12 Maintenance": {
    name: "Carla Simmons", role: "Maintenance planner",
    phone: "+1 (317) 555-0163", email: "carla.simmons@allisontransmission.com",
    hours: "Plant 12, Indianapolis · first shift 6am–2pm ET",
    respondsIn: "Answers the radio on shift", prefers: "call",
  },
  "Speedway Maintenance": {
    name: "Tony Bergeron", role: "Maintenance supervisor",
    phone: "+1 (317) 555-0148", email: "tony.bergeron@allisontransmission.com",
    hours: "Speedway, IN · 7am–4pm ET",
    respondsIn: "Phone first — rarely on a Maximo note", prefers: "call",
  },
  "Plant 14 Maintenance": {
    name: "Sarah Combs", role: "PM coordinator",
    phone: "+1 (317) 555-0192", email: "sarah.combs@allisontransmission.com",
    hours: "Plant 14, Indianapolis · 8am–5pm ET",
    respondsIn: "Replies to email same day", prefers: "email",
  },
  "Plant 3 Maintenance": {
    name: "Greg Lawson", role: "Stores & receiving lead",
    phone: "+1 (317) 555-0156", email: "greg.lawson@allisontransmission.com",
    hours: "Plant 3, Indianapolis · 8am–5pm ET",
    respondsIn: "Replies to email same day", prefers: "email",
  },
};
...
export interface ThreadEntry {
  ...
  kind: "email" | "call";
  /** True when Allison sent it or placed it — drives the icon. */
  outbound: boolean;
  from: string;
  to: string;
  when: string;
...
export function threadFor(row: ActionRow, agent: string): ThreadEntry[] {
  ...
  const us = row.partyOwn ? "planning@allisontransmission.com" : "sourcing@allisontransmission.com";
  const cause = causeOf(row.signal);
  ...
  if (cause === "supply") {
    ...
    return [
      ...
      },
      {
        ...
        kind: "email",
        outbound: true,
        from: `${agent.toLowerCase()}@allisontransmission.com`,
        to: "service@allisontransmission.com",
        when: "2 days ago",
