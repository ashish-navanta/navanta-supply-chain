      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            ...
            { label: "Single source", text: "Diffuse Color sits on one plant across $9.4M of annual demand" },
    ...
    prompts: [
      {
        ...
        kind: "read",
        answer: {
          note: "The SPC core consolidation, since it is the largest.",
          rows: [
            { label: "What", text: "Three plants carry the whole book; the tail styles hold $9.9M across sub-scale lines" },
            { label: "Why now", text: "Cline Tool & Service Co and Kirby Risk Supply Co both published volume tiers this year that we never took up" },
            { label: "Evidence", text: "Ariba quote 2025-0418 at −4.1% from 6,000 units, and a June capacity survey" },
            { label: "Risk", text: "Solan holds the density spec on two styles — requalification is six weeks" },
          ],
        },
      },
      {
        ...
        answer: {
          ...
          rows: [
            { label: "1", text: "SPC core consolidation — $2.4M over ten weeks, and the paper exists" },
            { label: "2", text: "Cat Lai FCL consolidation — $820K over eight, and it is a PO change not a negotiation" },
            { label: "3", text: "HTS reclassification — $1.25M but sixteen weeks and a ruling that can land either way" },
          ],
        },
      },
      {
        ...
        answer: {
          ...
          rows: [
            ...
            { label: "Where we sit", text: "3.1% under on Cline Tool & Service Co, 4% over on Cline Tool & Service Co — the price of its service level" },
      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Play", text: "OPP-111 — consolidate laminate onto Cline Tool & Service Co" },
    ...
    prompts: [
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Cline Tool & Service Co", text: "45 → 55 days · 91% OTIF · the anchor of the import book" },
            { label: "Kirby Risk Supply Co", text: "Out to 50 days · two containers rolled at Cat Lai" },
            { label: "Solan", text: "Out to 60 days · 78% OTIF, the weakest record we hold" },
            { label: "Cline Tool & Service Co", text: "Tufting capped for three months — internal, so reschedule rather than renegotiate" },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Cline Tool & Service Co", text: "$6.1M a year, onboarded through the legacy path, no term recorded" },
    ...
    prompts: [
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Play", text: "OPP-108 — retire the accessories tail onto Gulf Adhesives" },
            { label: "Gap", text: "Q3 landed $44K against a $60K ramp, 27% behind" },
            { label: "Cause", text: "Three suppliers hold regional exclusivity on a spec adhesive and are still ordering direct" },
      ...
      CLAIM_PROMPT,
      {
        ...
        answer: {
          ...
          rows: [
            ...
            { label: "SAP WM", text: "Allocation and pick level — trust it before the load is tendered" },
            { label: "SAP ECC", text: "Holds the original promise, and is the date on the account's portal" },
      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            ...
            { label: "Watch", text: "Cascade at 5.2, and both open claims are against the carrier not the plant" },
          ],
        },
      },
      {
