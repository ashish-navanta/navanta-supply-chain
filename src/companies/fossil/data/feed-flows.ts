    ...
    nodes: [
      {
        ...
        steps: (p, agent) => [
          ...
          line(
            ...
            `Dallas DC polymer line has second-shift capacity across the addressable volume, feedstock already contracted.`,
        ...
        outcome: {
          ...
          prompts: () => [
            ...
            "What's Dallas DC's utilisation ceiling?",
      ...
      },
      {
        ...
        steps: (p, agent) => [
          line(
            ...
            `Dallas DC line named as the primary source for the addressable ${money(p.addressable)} at second-shift rate.`,
        ...
        outcome: {
          ...
          lines: (p) => [
            `Dallas DC is the primary line on ${money(p.addressable)} of demand. The realized figure will show up on Value realization once the ERP posts the first quarter.`,
          ],
          artifact: (p) => ({
            kind: "doc",
            kicker: "SOURCING RULE · written",
            title: `${p.id} · Primary source · Dallas DC`,
            fields: [
            ...
            body: [
              `Dallas DC polymer line is the primary source for the addressable volume, priced at fully-loaded second-shift cost.`,
          ...
          prompts: () => [
            ...
            "What if Dallas DC utilisation shifts?",
        ...
        outcome: {
          ...
          artifact: (p) => ({
            ...
            fields: [
              ...
              { label: "Delivery", value: "Weekly · FCL, DDP Qi Guang Watch" },
