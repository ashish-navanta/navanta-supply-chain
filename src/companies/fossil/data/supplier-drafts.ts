...
export function supplierDraftFor(s: Supplier): SupplierDraft {
  /* Fossil-operated plants — internal capacity is a schedule question, not a
     supplier one. No outbound CTA. */
  ...
  shortlist: (s) => ({
    steps: [
      ...
      },
      {
        ...
        text: `RFQ package with volumes, spec sheets, and the delivery window Fossil asks for. Ready to send to the shortlisted set.`,
