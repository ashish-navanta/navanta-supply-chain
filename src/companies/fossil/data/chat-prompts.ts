    ...
    prompts: [
      {
        ...
        answer: {
          ...
          rows: [
            ...
            { label: "Why now", text: "Qi Guang Watch and Renley Watch Mfg both published volume tiers this year that we never took up" },
      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            ...
            { label: "Where we sit", text: "3.1% under on Qi Guang Watch, 4% over on Qi Guang Watch — the price of its service level" },
      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Play", text: "OPP-111 — consolidate laminate onto Qi Guang Watch" },
    ...
    prompts: [
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Qi Guang Watch", text: "45 → 55 days · 91% OTIF · the anchor of the import book" },
            { label: "Renley Watch Mfg", text: "Out to 50 days · two containers rolled at Cat Lai" },
            { label: "Solan", text: "Out to 60 days · 78% OTIF, the weakest record we hold" },
            { label: "Qi Guang Watch", text: "Tufting capped for three months — internal, so reschedule rather than renegotiate" },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        answer: {
          ...
          rows: [
            { label: "Qi Guang Watch", text: "$6.1M a year, onboarded through the legacy path, no term recorded" },
