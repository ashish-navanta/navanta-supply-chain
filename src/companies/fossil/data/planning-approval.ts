 ...
 *
 *  The buying seat's tasks are AUTHORED — a capped line at Solan, a
...
export function approvalTaskFor(e: Exception): AgentTask {
  ...
  return {
    ...
    /* One statement of the move. It used to append the recommendation
       lower-cased, which said the quantity twice and turned Qi Guang Watch into
       "cartersville" — "Approve 67 units — request 67 from adairsville on
       5T478-78519". The plant is a proper noun and the figure only needs saying
       once. */
    ask: short
