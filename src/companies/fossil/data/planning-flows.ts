 ...
 * that is actually exposed. The catalogue lists what Fossil sells; this
...
export function skuTaskFor(
  ...
  const steps = [
    ...
    },
    {
      ...
      source: worst ? `SAP APO · ${worst.key}` : "SAP APO · positions",
    },
    {
