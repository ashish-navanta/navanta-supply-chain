...
import type { AgentIcon, AgentStep, AgentTask, FlowArtifact } from "@/data/agent-actions";
      ...
      },
      {
        ...
        steps: (p, agent) => [
          ...
          line(
            ...
            `Quarterly reset, ±8% collar so a single spike does not blow the year — matches how the suppliers themselves buy their own inputs.`,
            `${agent} · clause draft`,
          ),
          line(
      ...
      },
      {
        ...
        outcome: {
          ...
          artifact: (p) => ({
            ...
            fields: [
              { label: "To", value: "counsel@target.com" },
              { label: "Cc", value: "finance@target.com" },
    ...
    nodes: [
      {
        ...
        steps: (p, agent) => [
          ...
          line(
            ...
            `The Cedar Mills Co-Pack dedicated lines have second-shift capacity across the addressable volume, ingredients already contracted.`,
        ...
        outcome: {
          ...
          lines: (p) => [
            `Running it on the dedicated lines lands ${money(p.recommended)} against the incumbent quote at ${p.confidencePct}% confidence. Next: cost internal production line by line.`,
          ],
          tiles: (p) => [
          ...
          artifact: () => ({
            kind: "compare",
            title: "External co-pack vs dedicated line · $/case",
            aLabel: "Buy",
            bLabel: "Make",
            rows: [
              { label: "Ingredients", a: "$19.40", b: "$18.60", delta: "−$0.80", tone: "good" },
              { label: "Conversion", a: "$7.20", b: "$5.40", delta: "−$1.80", tone: "good" },
              { label: "Overhead", a: "$2.10", b: "$2.60", delta: "+$0.50", tone: "behind" },
              { label: "Fully loaded", a: "$28.70", b: "$26.60", delta: "−$2.10", tone: "good" },
            ],
          }),
          prompts: () => [
            "Sensitivity if green coffee moves 10%?",
            "What's Cedar Mills' utilisation ceiling?",
      ...
      },
      {
        ...
        steps: (_p, agent) => [
          line(
            "Priced ingredients at the hedged marker",
            `Green arabica sits on the hedge that landed OPP-001 · the make case reads at the hedged number, not spot.`,
            `${agent} · ingredients`,
          ),
          line(
        ...
        outcome: {
          ...
          artifact: () => ({
            ...
            bLabel: "Stressed",
            rows: [
              { label: "Ingredients @ hedged marker", a: "$18.60", b: "$19.30", delta: "+$0.70" },
              { label: "Second-shift labour", a: "$3.10", b: "$3.10" },
              { label: "Energy @ negotiated rate", a: "$2.30", b: "$2.60", delta: "+$0.30" },
              { label: "Total make · $/case", a: "$26.60", b: "$27.60", delta: "+$1.00", tone: "behind" },
              { label: "Δ vs buy quote", a: "−$2.10", b: "−$1.10", tone: "good" },
            ],
          }),
          prompts: () => [
      ...
      },
      {
        ...
        steps: (p, agent) => [
          line(
            ...
            `Cedar Mills dedicated line named as the primary source for the addressable ${money(p.addressable)} at second-shift rate.`,
            `Order management · sourcing rules`,
          ),
          line(
        ...
        outcome: {
          ...
          lines: (p) => [
            `Cedar Mills is the primary line on ${money(p.addressable)} of demand. The realized figure will show up on Value realization once the ERP posts the first quarter.`,
          ],
          artifact: (p) => ({
            kind: "doc",
            kicker: "SOURCING RULE · written",
            title: `${p.id} · Primary source · Cedar Mills Co-Pack`,
            fields: [
            ...
            body: [
              `The Cedar Mills Co-Pack dedicated line is the primary source for the addressable volume, priced at fully-loaded second-shift cost.`,
          ...
          prompts: () => [
            ...
            "What if Cedar Mills utilisation shifts?",
    ...
    nodes: [
        ...
        outcome: {
          ...
          artifact: (p) => ({
            ...
            fields: [
              ...
              { label: "Delivery", value: "Weekly · FCL, DDP Woodland RDC" },
      ...
      },
      {
        ...
        steps: (_p, agent) => [
          line(
            "Screened the field",
            `Kept the vendors carrying the required audits and the right spec grade — three on the short list, two on the alternates.`,
        ...
        outcome: {
          ...
          artifact: () => ({
            ...
            rows: [
              { cells: ["Luen Hing Housewares", "CN", "BSCI", "94%", "Short list"], leader: true },
              { cells: ["Vinh Phat Textiles", "VN", "BSCI · OEKO-TEX", "92%", "Short list"] },
              { cells: ["Chaozhou Wei Sheng", "CN", "BSCI", "91%", "Short list"] },
              { cells: ["Minh Long Ceramics", "VN", "BSCI", "89%", "Alternate"] },
              { cells: ["Cebu Homecraft", "PH", "BSCI", "87%", "Alternate"] },
            ],
            footnote: "Short list gets the invite; alternates receive the pack on request.",
          }),
          prompts: () => [
            "Swap Chaozhou for a domestic alternate?",
        ...
        outcome: {
          ...
          artifact: (p) => ({
            ...
            fields: [
              ...
              { label: "Cc", value: "sourcing@target.com · tss@target.com" },
      ...
      },
      {
        ...
        outcome: {
          ...
          artifact: () => ({
            ...
            rows: [
              { cells: ["1", "Luen Hing Housewares", "−3.6%", "94%", "87"], leader: true },
              { cells: ["2", "Vinh Phat Textiles", "−2.1%", "94%", "81"] },
              { cells: ["3", "Chaozhou Wei Sheng", "+0.4%", "89%", "72"] },
              { cells: ["4", "Cebu Homecraft", "+1.2%", "87%", "68"] },
            ],
      ...
      },
      {
        ...
        outcome: {
          ...
          artifact: (p) => ({
            ...
            body: [
              `Luen Hing Housewares holds the addressable volume at the negotiated tier price, effective the next PO cycle.`,
