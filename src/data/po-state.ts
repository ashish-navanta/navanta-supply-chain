...
import { STAGE_LABEL, ORDER_STAGE_ORDER } from "@/data/service";
...
/**
 * A purchase order runs four stages, and they are Target's stages, not the plant's.
 *
 * A PO is INBOUND — it ends in a Target distribution centre, not at a customer —
 ...
 *
 * "In production" went with it. Target does not see inside a vendor's plant, so a
...
/**
 * Outbound: it leaves a Target RDC and ends at the account.
 *
