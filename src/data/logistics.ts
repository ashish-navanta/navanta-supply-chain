...
export const LOADS: Load[] = [
  ...
  },
  {
    ...
    pod: {
      ...
      at: "8 Aug · 11:20",
      exception: "2 units crushed under the wrap — photographed at the tailgate before the driver left",
      shortPallets: 2,
    },
    ...
    etas: [
      {
        ...
        eta: "Tomorrow 09:00",
        confidence: 60,
        note: "Tender is out to Kuehne+Nagel and unaccepted. The date is the ask, not a commitment.",
      },
    ],
    note: "Kuehne+Nagel quoted $2,400 over the fleet's all-in on this lane · #331 clears Dallas DC at 06:40 and could take it",
  },
  {
    id: "LD-70460",
    ...
    etas: [
      {
        ...
        eta: "Today 16:20",
        confidence: 88,
        note: "Recovery unit rolling from Dallas DC. Hours are legal to the relay point.",
      },
    ],
  ...
  },
  {
    ...
    note: "Purchased lane, carrier feed current · no fleet capacity west of Denver this week anyway",
  },
  {
    id: "LD-70463",
    orderId: "SO-4488",
    account: "Blue Ridge Jewelers",
    lane: "Nashville, TN → Asheville, NC",
    origin: "Eggstätt DC",
    destination: "Asheville, NC",
    miles: 296,
    haul: "purchased",
...
/* The "fleet": dedicated contract carriage at the Dallas DC — carrier-owned
...
export const FLEET: PowerUnit[] = [
  ...
  },
  {
    ...
    loadedMiles: 7_120,
    emptyMiles: 890,
    note: "Cleared Dallas DC at 06:40 with a full clock · the only unit legal for either the recovery or the Savannah tender",
  },
  {
    id: "276",
  ...
  },
  {
    ...
    loadedMiles: 5_890,
    emptyMiles: 720,
    note: "Full clock and the best loaded ratio in the fleet · under-used because Qi Guang Watch dispatches by habit",
  },
];
...
export const LANES: Lane[] = [
  /* The outbound wholesale legs out of Dallas, plus the inbound dray. Fossil
     ...
     handful of units under a monthly commitment at the Dallas DC. The
...
export const BACKHAULS: BackhaulOffer[] = [
  ...
  },
  {
    ...
    deliver: "Dallas DC · Tomorrow 14:30",
    revenue: 890,
    milesOutOfRoute: 21,
    expiresInHours: 21,
    unitId: "276",
...
export const ACCESSORIALS: Accessorial[] = [
  ...
  },
  {
    ...
    status: "accruing",
    amount: 350,
    note: "Recovery unit lays over at Dallas DC tonight · costed into the $2,400 recovery, not a surprise",
  },
  {
    id: "AC-8790",
    loadId: "LD-70441",
